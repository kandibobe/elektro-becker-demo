        ...
        <div className="prose prose-sm max-w-none text-[var(--color-muted)] space-y-6">
          ...
          <section>
            ...
            <p className="text-sm leading-relaxed">
              {electricianConfig.name} <span className="text-xs opacity-50">[fiktiv]</span>
              <br />
              {electricianConfig.addressDisplay} <span className="text-xs opacity-50">[fiktiv]</span>
            </p>
          </section>
          ...
          <section>
            ...
            <p className="text-sm leading-relaxed">
              Telefon: {electricianConfig.phone} <span className="text-xs opacity-50">[fiktiv]</span>
              <br />
              E-Mail: {electricianConfig.email} <span className="text-xs opacity-50">[fiktiv]</span>
            </p>
          </section>
