  ...
  const cards = [
    {
      icon: MapPin,
      label: t('address'),
      value: electricianConfig.addressDisplay,
      note: '(fiktiv)',
      href: undefined,
    },
    {
      icon: Phone,
      label: t('phone'),
      value: electricianConfig.phone,
      note: '(fiktiv)',
      href: electricianConfig.phoneHref,
    },
    {
      icon: Mail,
      label: t('email'),
      value: electricianConfig.email,
      note: undefined,
      href: `mailto:${electricianConfig.email}`,
    },
    {
      icon: Clock,
      label: t('hours'),
      value: `${electricianConfig.openingHours.weekdays} · ${electricianConfig.openingHours.saturday}`,
      note: electricianConfig.openingHours.emergency,
      href: undefined,
    },
  ];
    ...
    <section id="contact" className="section-padding bg-[var(--color-bg)]">
      <div className="container-narrow">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10">
          ...
          >
            <iframe
              src={electricianConfig.googleMapsEmbedUrl}
              width="100%"
              height="100%"
