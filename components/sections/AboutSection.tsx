        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          >
            <div className="relative h-[420px] lg:h-[500px] rounded-3xl overflow-hidden shadow-2xl shadow-[var(--color-slate)]/20">
              <Image
                src="https://images.unsplash.com/photo-1574180566232-aaad1b5b8450?w=800&q=85"
                alt={t('imageAlt')}
                fill
            ...
            >
              ...
              <div>
                ...
                <div className="text-[10px] text-[var(--color-muted)]">
                  {electricianConfig.certifications[0]}
                </div>
              </div>
            </motion.div>
            ...
            >
              <Wrench size={15} className="text-[var(--color-yellow)]" />
