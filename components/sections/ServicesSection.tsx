...
import { Zap, Wrench, Wifi, Sun, AlertTriangle, Car } from 'lucide-react';
import { SectionBadge } from '@components/ui/SectionBadge';
import { services } from '@lib/config';

const iconMap = { Zap, Wrench, Wifi, Sun, AlertTriangle, Car } as const;
          ...
          {services.map((service, i) => {
            ...
            return (
              ...
              >
                ...
                {/* Link */}
                <span className="text-xs font-semibold text-[var(--color-blue-glow)] group-hover:gap-2 flex items-center gap-1 transition-all duration-200">
                  {t('learnMore')}
