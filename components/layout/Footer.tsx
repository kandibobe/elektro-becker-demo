          ...
          <div className="space-y-4">
            <div className="flex items-center gap-2">
              <div className="w-8 h-8 rounded-lg bg-[var(--color-blue)] flex items-center justify-center">
                <Zap size={16} className="text-[var(--color-yellow)]" fill="currentColor" />
              </div>
              <span className="font-bold text-xl text-white">Elektro Becker</span>
            </div>
            ...
            <div className="flex flex-wrap gap-2 pt-1">
              {electricianConfig.certifications.map((cert) => (
                <span
                  key={cert}
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-3 text-sm text-white/55">
              <li className="flex items-start gap-2">
                ...
                <span>
                  {electricianConfig.addressDisplay}{' '}
              ...
              <li className="flex items-center gap-2">
                ...
                <span>
                  {electricianConfig.phone}{' '}
                  <span className="text-white/30 text-xs">(fiktiv)</span>
                </span>
              </li>
              <li className="flex items-center gap-2">
                <Mail size={14} className="shrink-0 text-[var(--color-blue-light)]" />
                <span className="text-xs break-all">{electricianConfig.email}</span>
              </li>
            </ul>
